...
# Mock data - only user's assignments
mock_assignments = [
    {
        "id": 1,
        "name": "PAC1",
        "description": "Desxrip",
        "instructions": "deai",
        "due_date": "2026-12-20T00:00:00",
        "exercises": [
            {"id": 1, "name": "Exercici 1", "description": "Primer exercisi", "points": 20, "order": 1},
            {"id": 2, "name": "Exercici 2", "description": "Descripció del segon exercici", "points": 80, "order": 2}
        ],
        "pdf_file_path": None,
        "pdf_file_name": None,
        "created_by": 1,
...
def view_assignment_pdf(assignment_id):
    ...
    # For demo purposes, return a mock PDF response since we don't have real files
    if not os.path.exists(file_path):
        # Return a simple PDF content type response for demo
